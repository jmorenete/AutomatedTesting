...
public class Step {
	...
	public void setup() {
		if (counter == 0) {
			reports = new ExtentReports("/Users/jmmore/Desktop/Report_test/reportParam.html", true);
		}
	...
	public void i_am_taken_to_a_list_of_data_for_that_search() throws Exception {
		...
		if (itemFound) {
			test.log(LogStatus.PASS, "Search term: "+searchTerm+" is in the returned page");
		} else {
			test.log(LogStatus.FAIL, "Search term: "+searchTerm+" is NOT in the returned page");
		}
